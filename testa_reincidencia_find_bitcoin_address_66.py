...
tested_keys = set()  # Conjunto para armazenar chaves já testadas
...
def random_key_check():
    while True:
        ...
        # Verifica se a chave já foi testada
        with lock:
            if private_key_int in tested_keys:
                continue
            tested_keys.add(private_key_int)
